...
/* Definitions for peripheral AXI_GPIO_UWB */
#define XPAR_AXI_GPIO_UWB_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_UWB_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_UWB_DEVICE_ID 2
#define XPAR_AXI_GPIO_UWB_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_UWB_IS_DUAL 1
...
/* Canonical definitions for peripheral AXI_GPIO_UWB */
#define XPAR_GPIO_2_BASEADDR 0x41210000
#define XPAR_GPIO_2_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_UWB_DEVICE_ID
...
#define XPAR_FABRIC_AXI_QUAD_SPI_UWB_IP2INTC_IRPT_INTR 63
...
/* Definitions for peripheral AXI_QUAD_SPI_UWB */
#define XPAR_AXI_QUAD_SPI_UWB_DEVICE_ID 0
#define XPAR_AXI_QUAD_SPI_UWB_BASEADDR 0x41E00000
#define XPAR_AXI_QUAD_SPI_UWB_HIGHADDR 0x41E0FFFF
#define XPAR_AXI_QUAD_SPI_UWB_FIFO_DEPTH 0
#define XPAR_AXI_QUAD_SPI_UWB_FIFO_EXIST 0
#define XPAR_AXI_QUAD_SPI_UWB_SPI_SLAVE_ONLY 0
#define XPAR_AXI_QUAD_SPI_UWB_NUM_SS_BITS 1
#define XPAR_AXI_QUAD_SPI_UWB_NUM_TRANSFER_BITS 8
#define XPAR_AXI_QUAD_SPI_UWB_SPI_MODE 0
#define XPAR_AXI_QUAD_SPI_UWB_TYPE_OF_AXI4_INTERFACE 0
#define XPAR_AXI_QUAD_SPI_UWB_AXI4_BASEADDR 0
#define XPAR_AXI_QUAD_SPI_UWB_AXI4_HIGHADDR 0
#define XPAR_AXI_QUAD_SPI_UWB_XIP_MODE 0

/* Canonical definitions for peripheral AXI_QUAD_SPI_UWB */
