# Parameters
outfile = "velPos_cal_compFilter.pdf";
f_norm = [331; -263; 8082];
gyr_sens = 32.8;
acc_sens = 8192;
delta_t = 1/500;
...
# Load Quaternions (after calibration and filtering)
load('quat_cal_compFil.mat', 'quat_cal_compFil');
qw = quat_cal_compFil(:,1);
qx = quat_cal_compFil(:,2);
qy = quat_cal_compFil(:,3);
qz = quat_cal_compFil(:,4);
