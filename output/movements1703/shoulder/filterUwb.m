...
printf("Final displacement: %d\r\n", mean(filtered_uwb(1:100)) - filtered_uwb(9750));
printf("Displacement at 90dgr: %d\r\n", mean(filtered_uwb(1:100)) - filtered_uwb(6000));
...
% Plot (eps)
plot(uwb_raw(1:9750), "r");
hold on;
plot(filtered_uwb(1:9750), "c");
hold on;
